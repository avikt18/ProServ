                            ...
                            >
                                <div className="md:w-full max-w-md w-80 p-5 md:p-8 space-y-3 bg-white border-[2px] border-black shadow-card before:bg-[#808080] ">
                                    <form className='flex flex-col items-start font-medium'>
                                        <label className='mb-2 text-sm md:text-[16px]'>Name</label>
                                        <input 
                                            className='w-full bg-superlightGray mb-5 rounded-md px-2 py-3 focus-visible:outline-none' 
                                            type="text" 
                                            id="name" 
                                            name="name"
                                        ...
                                        <input type="submit" value="SignUp" className='bg-lightGreen relative mb-3 cursor-pointer px-5 py-2 font-medium rounded-md text-black font-secondary' onClick={signupHandler} />
                                    </form>
