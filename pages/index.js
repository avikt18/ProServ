  ...
  const { data: session } = useSession()
    ...
    return (
      <div>
        ...
        <div className="container lg:text-left absolute -z-20 text-center px-4 flex flex-col items-center min-w-full font-medium">
          {/* Navbar */}
          <Navbar />
          ...
          {/* Seller Card  */}
          <div className="w-full gcwidth:max-w-[1370px] max-w-box  py-7 text-center lg:text-left px-8 flex justify-center items-center relative bg-lightGray mt-12 rounded-[20px] shadow-card before:bg-black">
            <div className="flex items-center justify-between w-full h-full max-w-box mb-3">
              <div className="w-full flex flex-col items-center lg:items-start">
                <h1 className="font-medium text-4xl leading-[50px]">Wanna monetize your skill?<br />Sell your services on WebsiteName</h1>
                <p className='lg:text-lg mt-4 font-normal opacity-70'>You do the work,<br className='hidden lg:block' />for all services you need</p>
                <div className="mt-6">
                  <div className="bg-black absolute translate-y-1 translate-x-1 px-4 py-2 font-medium rounded-md text-black font-secondary">Become a Seller</div>
                  <Button style="bg-lightGreen relative px-4 py-2 font-medium rounded-md text-black font-secondary">Become a Seller</Button>
                </div>
              </div>
              <div className="mr-10 lg:block hidden">
                <Image src='/boy.svg' height="350.13" width="441" alt='boy illustration' />
